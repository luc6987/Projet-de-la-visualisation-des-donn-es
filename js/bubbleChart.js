...
Promise.all([
  ...
  // Process data: get max total_cases and total_deaths per country
  ...
  // Convert to array and calculate mortality rate
...
function createBubbleChart(data) {
  ...
  // Color scale: green (low mortality) to red (high mortality)
  const colorScale = d3.scaleSequential()
    .domain([minMortality, maxMortality])
    .interpolator(d3.interpolateRdYlGn)
    .domain([maxMortality, minMortality]); // Reverse for red=high, green=low
