...
import { plotPyramidBarCharts } from './barPlot.js?v=4';
import { plotCumulativeUptake } from './tsPlot.js?v=2';
import { createMapViz, highlightCountries, addCovidOverlay, showCovidStats } from './map.js?v=5';
